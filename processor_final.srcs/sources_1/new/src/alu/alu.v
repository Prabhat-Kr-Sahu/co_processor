...
module pipelined_alu(
    ...
    always @(*) begin
        case(alu_control)
            ...
            // --- MODIFICATION HERE ---
            // This was LHU address, but testbench uses it for MUL.
            // This is now an R-Type (M-Extension) operation.
            6'b011000: begin                                                    // MUL
                result = forwarded_src1 * final_src2;
                $display("ALU MUL: %h * %h = %h", forwarded_src1, final_src2, result);
            end
            ...
            // U-TYPE AND J-TYPE OPERATIONS
            6'b100010: result = imm_val_r;                                      // LUI
            6'b100011: result = imm_val_r;            // AUIPC
            6'b100100: result = (forwarded_src1 + imm_val_r) & ~1;             // JALR
